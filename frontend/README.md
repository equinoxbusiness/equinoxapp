...
This directory has a basic Dapp to interact with contracts, built using
React.
...
To run it, you just need to execute `npm install`and then `npm start` in a terminal, and open
...
Use the `Dapp` component as a starting point for your project. It has
